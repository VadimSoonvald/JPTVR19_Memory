...
x2 = pygame.image.load("krestik.png")
x2 = pygame.transform.scale(x2,(200,200))
#screen.blit(x,(200,0))
#screen.blit(x,(0,0))
#screen.blit(x,(400,0))

o = pygame.image.load("nolik.png")
o = pygame.transform.scale(o,(200,200))
#screen.blit(o,(0,200))

text = pygame.font.Font(None, 50)
text_1 = text.render("", 1, [0, 0, 0])
screen.blit(text_1, [250, 750])
        ...
        if event.type == pygame.QUIT:
            ...
            if step >=5:
                if wins() == True:
                    if step %2 ==  1:
                        print("X won!")
                        text_1 = text.render("X won!", 1, [0, 0, 0])
                        screen.blit(text_1, [250, 750])
                    else:
                        print("O won!")
                        text_1 = text.render("O won!", 1, [0, 0, 0])
                        screen.blit(text_1, [250, 750])
                        pygame.display.flip()
